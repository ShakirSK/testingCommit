...
public class u_MyProfile_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.u_myprofile);
        //activity_u__my_profile_
        ...
        soname= findViewById(R.id.societyname);
        soaddress= findViewById(R.id.location);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObject.getString("status").equals("1"))
                                {
                                    ...
                                    Picasso.with(getApplicationContext()).load(profurl).placeholder(R.drawable.ic_person_black_24dp).error(R.drawable.ic_person_black_24dp).fit().into(profile);

...
public class  PartyLedgerDetailPage_UserAdapter extends RecyclerView.Adapter< PartyLedgerDetailPage_UserAdapter.ViewHolder> implements Filterable {
    ...
    String amtotal;
    public  PartyLedgerDetailPage_UserAdapter(Context context, List<partydetailmodel> trailbal) {
        this.context = context;
        this.trailbal = trailbal;
        this.contactListFiltered = trailbal;
    }
...
*/
        holder.textRating.setText(movie.getDate() +" | "+ String.valueOf(movie.getVoucher_type()));

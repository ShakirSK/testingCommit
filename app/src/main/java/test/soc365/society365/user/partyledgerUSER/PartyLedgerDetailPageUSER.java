package test.soc365.society365.user.partyledgerUSER;
...
public class PartyLedgerDetailPageUSER extends AppCompatActivity {
    ...
    public PartyLedgerDetailPage_UserAdapter adapter;
...
*/
        ...
        calander.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PartyLedgerDetailPageUSER.this,
...
*/
                                        ...
                                        adapter = new PartyLedgerDetailPage_UserAdapter(getApplicationContext(),movieList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            if(CheckNetwork.isInternetAvailable(PartyLedgerDetailPageUSER.this)) //returns true if internet available
            {
                if(urlstring==null)
                {
...
*/
        ...
        builder = new AlertDialog.Builder(PartyLedgerDetailPageUSER.this);
